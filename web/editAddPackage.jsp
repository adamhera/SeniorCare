...
<html>
<head>
    <title><%= (request.getAttribute("packageID") != null ? "Edit Package" : "Add Package") %></title>
</head>
<body>
    <h2><%= (request.getAttribute("packageID") != null ? "Edit Package" : "Add Package") %></h2>

    <form action="<%= (request.getAttribute("packageID") != null ? "EditPackageServlet" : "AddPackageServlet") %>" method="POST">
        ...
        <input type="number" name="packagePrice" step="0.01" value="<%= (request.getAttribute("packagePrice") != null ? new DecimalFormat("#.00").format(request.getAttribute("packagePrice")) : "") %>" required>
        <br>
